...
console.log("===================================================");
console.log("=============== Battleship Simulator ==============");
console.log("===================================================");
console.log("")

// ✅Se describen los tipos de barcos
...
console.log("");
console.log("");
// Si el jugador A hunde los barcos de jugadro B, entonces gana el jugador A. 
if (Player1.points > Player2.points ) {
	Player1.win();
	playerWin = "Player A";
	// Si el jugadro B hunde los barcos del jugador A, entonces gana el jugador B.
} else if (Player2.points > Player1.points ) {
		Player2.win();
		playerWin = "Player B";
			// De lo contrario sería empate
} else {
